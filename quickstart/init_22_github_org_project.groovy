...
Logger logger = Logger.getLogger("init_22_github_org_project.groovy")

def j = Jenkins.instance

File disableScript = new File(j.rootDir, ".disable-init_22_github_org_project")
if (disableScript.exists()) {
    logger.info("DISABLED init_22_github_org_project script")
    return
}
